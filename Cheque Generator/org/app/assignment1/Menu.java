...
public class Menu {
    ...
    public static void addBill() {
        ...
        ArrayList<String> monthList = new ArrayList<>(Arrays.
        ...
        Bill bill = new Bill(companyName, amount, monthNumber, day, year);
        payable.add(bill);
    ...
    public static void issueCheques() {
        ...
        if (!payable.isEmpty()) {
            ...
            System.out.printf("...All cheques till %s have been issued !!\n", formatDateTime);
